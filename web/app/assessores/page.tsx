  ...
  return (
    <div>
      ...
      <p className="mb-2 max-w-2xl text-sm text-tinta-suave">
        Quem trabalha nos gabinetes da Câmara e em qual deputado. Busque por nome para encontrar uma pessoa
        específica ou cruzar nomes entre gabinetes. Os dados são públicos; as conclusões são de quem lê.
      </p>
      <p className="mb-6 max-w-2xl text-xs text-tinta-tenue">
        Snapshot atual da Câmara (Paraíba). A fonte traz nome, nível salarial e nomeação — não o CPF nem o que cada
        um faz. Senado e Assembleia não divulgam o quadro de gabinete por parlamentar.
      </p>
