...
const BLOCOS: Bloco[] = [
  ...
  },
  {
    ...
    fontes: [
      ...
      { oque: 'Folha (Campina Grande, Bayeux) — PublicSoft', onde: 'portaldoservidor-api.publicsoft.com.br/api/.../webservice/api?db={db}&params={tipo,mês,ano}', formato: 'JSON (API)', obs: 'Portal do Servidor; tipoCargo "Eletivo" = subsídio do vereador; "Comissionado" somados = folha de comissionados. {db} = base64 do CNPJ da câmara' },
