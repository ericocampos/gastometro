...
const BLOCOS: Bloco[] = [
  ...
  },
  {
    ...
    fontes: [
      ...
      { oque: 'Página da VIAP na câmara', onde: 'santarita.pb.leg.br/site/viap · camarapatos.pb.gov.br/consultas/viap', formato: 'link humano', obs: 'a câmara não publica o detalhamento da VIAP de forma legível por máquina (Santa Rita só PDF escaneado, com defasagem; Patos apenas aponta para o TCE). Servem como link para a fonte: dá para conferir o fluxo do dinheiro no TCE, não o conteúdo de cada nota' },
      { oque: 'Partido e foto', onde: 'TSE (eleição municipal de 2024)', formato: 'CSV + JPG', obs: 'mesma fonte usada nas câmaras do modelo leve' },
    ],
  },
  {
