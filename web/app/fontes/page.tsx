...
const BLOCOS: Bloco[] = [
  ...
  },
  {
    ...
    fontes: [
      ...
      { oque: 'Cajazeiras — vereadores + folha', onde: 'transparencia-api.elmartecnologia.com.br/api/101046/pessoal/folha_pagamento', formato: 'JSON (API)', obs: 'Elmar; cargo "VEREADOR" = subsídio; comissionados de cargo "SECRETARIO PARLAMENTAR" somados = folha de gabinete' },
      { oque: 'Guarabira — vereadores + folha', onde: 'transparencia-api.elmartecnologia.com.br/api/101082/pessoal/folha_pagamento', formato: 'JSON (API)', obs: 'Elmar; cargo "VEREADOR" = subsídio; comissionados de cargo "PARLAMENTAR/GABINETE" somados = folha de gabinete' },
      { oque: 'Queimadas — vereadores + folha', onde: 'transparencia-api.elmartecnologia.com.br/api/101155/pessoal/folha_pagamento', formato: 'JSON (API)', obs: 'Elmar; cargo "VEREADOR (A)" = subsídio; comissionados de cargo "... PARLAMENTAR" somados = folha de gabinete' },
      { oque: 'Pombal — vereadores + folha', onde: 'transparencia-api.elmartecnologia.com.br/api/101151/pessoal/folha_pagamento', formato: 'JSON (API)', obs: 'Elmar; cargo "VEREADOR" = subsídio; comissionados de cargo "ASSESSOR PARLAMENTAR" somados = folha de gabinete' },
