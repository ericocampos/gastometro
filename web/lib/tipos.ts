...
export interface CeapPorUf { fonte: string; atualizadoEm: string; valores: Record<string, number | null>; reajuste?: { aPartirDe: number; fator: number } }
export interface ViapTetoMudancas { fonte: string; observacao?: string; mudancas: Record<string, { aPartirDe: number; valor: number }> }
