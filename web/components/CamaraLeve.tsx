...
function Card({ rotulo, valor, legenda }: { rotulo: string; valor: string; legenda: string }) {
  return (
    <div className="rounded-xl border border-borda bg-superficie p-3 sm:p-4" style={{ borderLeft: `3px solid ${TEAL}` }}>
      ...
      <p className="mt-2 font-display text-lg font-semibold leading-none tabular-nums text-tinta sm:text-2xl lg:text-3xl">{valor}</p>
