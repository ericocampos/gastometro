...
export interface LinhaEmenda { rotulo: string; sub: string; empenhado: number; pago: number }
          ...
          {linhas.map((l) => (
            ...
            >
              <td className="px-4 py-2.5">
                <span data-testid="emenda-rotulo" className="font-semibold text-tinta">{l.rotulo}</span>
