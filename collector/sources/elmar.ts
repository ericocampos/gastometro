...
// Usado só pelo modelo COMPLETO (João Pessoa): roster + VIAP + gabinete por vereador. As demais
// câmaras (modelo leve) vêm da fonte única do TCE-PB (ver sources/tce.ts).
